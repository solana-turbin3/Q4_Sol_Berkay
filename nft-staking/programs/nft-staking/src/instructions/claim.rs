...
pub struct Claim<'info> {
    ...
    #[account(
        mut, // since when we mint, the supply will be increased, we need to mutate it
...
impl<'info> Claim<'info> {
    pub fn claim(&mut self) -> Result<()> {
        ...
        let cpi_accounts = MintTo {
            ...
            authority: self.config_account.to_account_info(), // since the owner of the rewards mint is the config account
        };
